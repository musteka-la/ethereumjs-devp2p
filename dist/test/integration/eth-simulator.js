...
tape_1.default('ETH: send status message (successful)', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var opts;
...
tape_1.default('ETH: send status message (NetworkId mismatch)', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var opts, status1;
    return __generator(this, function (_a) {
        opts = {};
        opts.status0 = Object.assign({}, status);
...
tape_1.default('ETH: send allowed eth63', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var opts;
    return __generator(this, function (_a) {
        opts = {};
        opts.status0 = Object.assign({}, status);
...
tape_1.default('ETH: send allowed eth62', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var cap, opts;
    return __generator(this, function (_a) {
        cap = [devp2p.ETH.eth62];
        opts = {};
        opts.status0 = Object.assign({}, status);
        opts.status1 = Object.assign({}, status);
        opts.onOnceStatus0 = function (rlpxs, eth) {
...
tape_1.default('ETH: send not-allowed eth62', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var cap, opts;
    return __generator(this, function (_a) {
        cap = [devp2p.ETH.eth62];
        opts = {};
        ...
        opts.onOnceStatus0 = function (rlpxs, eth) {
            try {
                ...
                var msg = 'Error: Code 13 not allowed with version 62';
...
tape_1.default('ETH: send unknown message code', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var opts;
    return __generator(this, function (_a) {
        opts = {};
        opts.status0 = Object.assign({}, status);
...
tape_1.default('ETH: invalid status send', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var opts;
    return __generator(this, function (_a) {
        opts = {};
        opts.status0 = Object.assign({}, status);
